...
_Una vez instalado las librerias escribe en tu terminal en la ubicacion raiz del respositorio:_
...
* [MediaPipe](https://google.github.io/mediapipe/solutions/hands) - Libreria principal para la deteccion de la posicion de las manos
* [OpenCV](https://docs.opencv.org/4.5.5/) - Visor y capturador de imagen para la identificacion 
* [NumPy](https://numpy.org/) - Usado para generar normalizacion de las coordenadas

## Contribuyendo 🖇️

Por favor comunicate [Contactar](https://api.whatsapp.com/send/?phone=+573226099206) para detalles de nuestro código de conducta, y el proceso para enviarnos pull requests.
